			...
			class UberGrid
				...
				updateWidth: =>
					...
					if options.autosize
						...
						cellWidth = (width - gutter + border * 2) / 2 if columns == 2 and cellWidth * 2 + border * 2 + gutter > width
						...
						@$el.find(".uber-grid-cell.r2c2, .uber-grid-cell.r2c2 .uber-grid-cell-wrapper").width cellWidth * 2 + gutter + border * 2
